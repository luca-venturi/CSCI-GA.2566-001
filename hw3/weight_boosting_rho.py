# Luca Venturi
# modification of the 'sklearn' package function 'AdaBoostClassifier'
# allows to select an additional parameter rho
# classic AdaBoost is for rho = 0
...
class AdaBoostClassifier(BaseWeightBoosting, ClassifierMixin):
    ...
    def _boost_discrete(self, iboost, X, y, sample_weight, random_state):
        ...
        estimator_weight = self.learning_rate * (
            ...
            np.log(n_classes - 1.) + self._correction_) # _mod_
